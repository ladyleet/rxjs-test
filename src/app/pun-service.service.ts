...
const puns = {
    '0': { pun: 'My wife has banana diet', answer: 'She hasnt lost weight, but you should see her climb trees now!'
  },
    '1': { pun: 'Id make a pun about a chicken...', answer: 'But it would be fowl'
  },
    '2': { pun: 'this is a pun about a pickle and a hat', answer: 'answer'
  }
};
